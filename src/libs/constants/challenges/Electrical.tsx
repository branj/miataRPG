...
const LEVEL_1 =  UtilFactory.make(
    ...
    [TrophyFactory.make('Electrical Trophy', 'Apprentice')],
    []
);
const LEVEL_2 = UtilFactory.make(
    100, 
    "Novice Challenge Reward",
    [TrophyFactory.make('Electrical Trophy', 'Novice')], 
    [],
)
const LEVEL_3 = UtilFactory.make(
    150, 
    "Pro Challenge Reward",
    [TrophyFactory.make('Electrical Trophy', 'Pro')], 
    [],
)

export const ELECTRICAL_CHALLENGES = [
